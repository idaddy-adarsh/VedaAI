...
passport.use(new GoogleStrategy({
    ...
    callbackURL: "https://vedaai.onrender.com/auth/google/callback"
},
...
// Google Auth Routes
app.get('https://vedaai.onrender.com/auth/google',
    passport.authenticate('google', { scope: ['profile', 'email'] }));

app.get('https://vedaai.onrender.com/auth/google/callback', 
